...
export const translations = {
  en: {
    ...
    hero: {
      ...
      text: 'ECU (Electronic Coin Unit) is a utility token of the TON network, used in ECU Protocol smart contracts. The protocol performs on-chain operations with digital objects created and managed through contract logic. ECU is used as the internal unit of protocol operations when users interact with the system. All operations are executed in the TON blockchain and can be verified through public explorers. ECU is not an investment instrument.',
